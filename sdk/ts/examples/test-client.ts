...
const client = new Client({
  ...
  apiKey: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..KDAQDCUrpUeFI9gkDwcZr5_vP9dPoh-adlv25JK-je8'
})
...
try {
  ...
  const newKubernetesVersion = await client.createApplicationVersion(newKubernetesApp, {
    name: "v1",
    chartName: "my-chart",
    chartVersion: "1.0.0",
