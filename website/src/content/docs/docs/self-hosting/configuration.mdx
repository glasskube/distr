...
client secrets, SMTP passwords, pull-through registry credentials, deployment value and env files, support bundle
resources, MFA secrets, Stripe webhook secrets and entitlement registry passwords.
